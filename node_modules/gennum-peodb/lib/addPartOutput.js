...
module.exports = function(PEODB) {
  ...
  PEODB.prototype.addPartOutput = function(args, cb) {
    var peodb = this;
    ...
    peodb.checkPartflowRole(args, 'PE', function(err) {
      ...
      peodb.dbSession(args, function(db, cb) {
        addPartOutput(db, args, cb);
      }, cb);
    });
  }

  function addPartOutput(db, args, cb) {
    db.transaction(function(cb) {
      var qStr = [
        'INSERT INTO part_outputs (',
        '  part_output_id, step_id, part_id, count',
        ') VALUES (',
        '  NULL',
